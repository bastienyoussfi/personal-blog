            ...
            <div className="flex flex-col md:flex-row md:items-start gap-6">
              <div className="md:w-7/12">
                ...
                <Link href={`/blog/${featuredPost.id}`} className="group">
                  <h2 className="text-xl font-bold mb-1 text-gray-900 leading-tight group-hover:underline">{featuredPost.title}</h2>
                </Link>
                ...
                <div className="flex flex-col md:flex-row md:items-start gap-6">
                  <div className="md:w-7/12">
                    ...
                    <Link href={`/blog/${post.id}`} className="group">
                      <h3 className="text-lg font-bold mb-1 text-gray-900 leading-tight group-hover:underline">{post.title}</h3>
                    </Link>
